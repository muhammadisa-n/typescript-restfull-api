  ...
  it("should create new contact", async () => {
    const response = await supertest(web)
      ...
      .send({
        ...
        email: "muhammadisa0704@example.com",
        phone: "0899999",
      });
    ...
    expect(response.body.data.first_name).toBe("Muhammad");
    expect(response.body.data.last_name).toBe("Isa Nuruddin");
    expect(response.body.data.email).toBe("muhammadisa0704@example.com");
...
describe("PUT /api/contacts/:contactId", () => {
  ...
  it("should be able to update contact", async () => {
    ...
    expect(response.body.data.first_name).toBe("muhammad");
    expect(response.body.data.last_name).toBe("isa");
    expect(response.body.data.email).toBe("muhisa@example.com");
